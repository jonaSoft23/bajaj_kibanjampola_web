      ...
      {/* { showSettings ? (
        <Card className="theme-settings">
          <Card.Body className="pt-4">
            ...
            <Button as={Link} to={Routes.DashboardOverview.path} variant="secondary" className="mb-3 w-100"><FontAwesomeIcon icon={faRocket} className="me-1" /> Upgrade to Pro</Button>
        ...
        <Row>
          ...
          <Col xs={12} lg={6}>
            <ul className="list-inline list-group-flush list-group-borderless text-center text-xl-right mb-0">
              ...
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link  target="_blank">
                  <Link to={`/riders/view-riders`}>Riders</Link>
              </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link  target="_blank">
